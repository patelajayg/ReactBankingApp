        ...
        <div>
          <div className="form-row">
            ...
            <div className="row">
              ...
              <div className="form-group col-md-6">
                <label htmlFor="inputPassword4">Pan No</label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="PAN"
            ...
            <div className="row">
              <div className="form-group col-md-6">
                <label htmlFor="inputPassword4">Adhar no</label>
                <input
                  type="text"
                  className="form-control"
